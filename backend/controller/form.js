...
exports.verifyPayment = async (req, res) => {
    try {
        ...
        if (generatedSignature === razorpay_signature) {
            ...
            //     enrollmentNumber: `Mr. Saifi${1000 + AthleteEnrollmentCount + 1}`,
            //     regNo: userData._id,
            // });
